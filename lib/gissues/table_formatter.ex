defmodule Gissues.TableFormatter do
  ...
  Prints a table to STDOUT of the data from each row identified by
  each header. That is, each header identifies a column, and those
  columns are extracted and printed from the rows. We calculate the width
  of each column to fit the longest element in that column.
  """
  ...
  ## Example
      ...
      iex> Gissues.TableFormatter.split_into_columns(list, ["a", "b", "c"])
      [ ["1", "4"], ["2", "5"], ["3", "6"] ]
  """
  ...
  ## Examples
      iex> Gissues.TableFormatter.printable("a")
      "a"
      iex> Gissues.TableFormatter.printable(99)
      "99"
  """
  ...
  ## Example
      ...
      iex> Gissues.TableFormatter.widths_of(data)
      [ 6, 8 ]
  """
  ...
  ## Example
      iex> widths = [ 5, 6, 99 ]
      iex> Gissues.TableFormatter.format_for(widths)
      "~-5s | ~-6s | ~-99s~n"
  """
  ...
  ## Example
      iex> widths = [ 5, 6, 9 ]
      iex> Gissues.TableFormatter.separator(widths)
      "------+--------+----------"
  """
